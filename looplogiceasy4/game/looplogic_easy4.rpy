...
init:
    image bg Logic_Gate = "LoopLogic_background.png"

label start: #loopLogic_easy5
    #loads background
    scene bg Logic_Gate
    ...
    image LLE4tile3 = "g_vertical.png"
    ...
    image LLE4tile7 = "G_vertical.png"
...
#*******************************************
    ...
    if if1in1 == True:
        image LLE42tile1 = "g_horizontal.png"
    ...
    if if2in2 == True:
        ...
        image LLE41tile9 = "W_connect.png"
    ...
    if if1in3 == True:
        if if2in2 == True:            
            image LLE41tile21 = "g_horizontal.png"
    ...
    if if3in3 == True:
        ...
        if if2in2 == True:
            image LLE432tile21 = "g_horizontal.png"
