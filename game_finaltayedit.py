...
#generates the score sprite and updates
...
#generates the attempts sprites and updates for it
...
def main():
    #initilizes game
    pygame.init()
    #sets up display and adds title to the border
    screen = pygame.display.set_mode((1520, 930))
    pygame.display.set_caption('Binary Memory Game')
    #initilizes fint fo game
    pygame.font.init()
    myfont = pygame.font.SysFont("None", 25)
    #sest winner vairibale for loop
    winner = True
