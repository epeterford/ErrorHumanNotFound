...
#*******************************************
    ...
    if ifGRin7 == True:
        ...
        if ifGin8 == True:
            ...
            if (elsein3 == True or ifRin3 == True):
                $LLH_4_node4 = "Red"
        ...
        if ifRin8 == True:
            ...
            if (elsein3 == True or ifGin3 == True):
                $LLH_4_node4 = "Green"
                $LLH_4_node5 = "Green"
    ...
    if ifBGin7 == True:
        ...
        if ifGin8 == True:
            ...
            if (elsein3 == True or ifB1in3 == True or ifB2in3 == True):
                $LLH_4_node4 = "Blue"
                $LLH_4_node5 = "Blue"
        ...
        if ifB1in8 == True or ifB2in8 == True:
    ...
    if ifB1in3 == True or ifB2in3 == True:
        if ifBGin7 == True and (ifB1in8 == True or ifB2in8 == True or ifGRin8 == True):
            $LLH_4_node4 = "Blue"
            $LLH_4_node5 = "Blue"
            image LLH_4_colorTile38 = "B_vertical.png"
            show LLH_4_colorTile38 at Position(xpos = 775, xanchor = 0, ypos = 595, yanchor = 0)
            image LLH_4_colorTile73 = "B_vertical.png"
            show LLH_4_colorTile73 at Position(xpos = 775, xanchor = 0, ypos = 520, yanchor = 0)
            image LLH_4_colorTile74 = "B_horizontal_short.png"
            show LLH_4_colorTile74 at Position(xpos = 825, xanchor = 0, ypos = 490, yanchor = 0)
            image LLH_4_colorTile75 = "B_horizontal.png"
            show LLH_4_colorTile75 at Position(xpos = 925, xanchor = 0, ypos = 490, yanchor = 0)
            image LLH_4_colorTile76 = "B_connect_pipe_vertical.png"
            show LLH_4_colorTile76 at Position(xpos = 785, xanchor = 0, ypos = 681, yanchor = 0)  
            image LLH_4_colorTile81 = "W_corner_RB.png"
            show LLH_4_colorTile81 at Position(xpos = 748, xanchor = 0, ypos = 465, yanchor = 0)          
        else:
            hide LLH_4_colorTile38
            hide LLH_4_colorTile73
            hide LLH_4_colorTile74
            hide LLH_4_colorTile75
            hide LLH_4_colorTile76
            hide LLH_4_colorTile81
    else:
        hide LLH_4_colorTile38
        hide LLH_4_colorTile73
        hide LLH_4_colorTile74
    ...
    if ifRin4 == True and ifGRin6 == True:
    ...
    if ifGin4 == True and (ifGRin6 == True or ifBGin6 == True):
    ...
    if (ifB1in4 == True or ifB2in4 == True) and ifBGin6 == True:
    ...
    if whileGin4 == True:
        if (ifGRin6 == True or ifBGin6 == True):
            $LLH_4_GWhileNode = "On"
    ...
    if ifBGin6 == True:
        if ifGin5 == True:
            image LLH_4_colorTile44 = "G_horizontal_ll.png"
            show LLH_4_colorTile44 at Position(xpos = 200, xanchor = 0, ypos = 695, yanchor = 0)
            image LLH_4_colorTile45 = "G_vertical_ll.png"
            show LLH_4_colorTile45 at Position(xpos = 132, xanchor = 0, ypos = 580, yanchor = 0)
        else:
            hide LLH_4_colorTile44
            hide LLH_4_colorTile45
        
        if (ifB1in5 == True or ifB2in5 == True):
            $LLH_4_BEnd2 = "On"
    ...
    if ifRin1 == True:
        if whileGin4 == True and (ifGRin6 == True or ifBGin6 == True):
            $LLH_4_REnd1 = "On"
    ...
    if ifGRin1 == True:
        ...
        if whileGin4 == True and ifBGin6 == True:
    ...
    if elsein2 == True:
        ...
        if ifGRin1 == True:
            ...
            hide LLH_4_colorTile101
            hide LLH_4_colorTile102
        if ifBGin1 == True and whileGin4 == True and ifGRin6 == True:
            $LLH_4_node1 = "Red"
            $LLH_4_node2 = "Red"
            $LLH_4_node3 = "Red"
    ...
    if ifRin2 == True:
        if whileGin4 == True and (ifBGin6 == True or ifGRin6 == True) and (ifGin1 == True or ifB1in1 == True or ifB2in1 == True or ifGRin1 == True or ifBGin1 == True):
            $LLH_4_node1 = "Red"
            $LLH_4_node2 = "Red"
            $LLH_4_node3 = "Red"
            image LLH_4_colorTile63 = "R_connect_pipe.png"
            show LLH_4_colorTile63 at Position(xpos = 480, xanchor = 0, ypos = 500, yanchor = 0)
            image LLH_4_colorTile64 = "R_connect_pipe.png"
            show LLH_4_colorTile64 at Position(xpos = 520, xanchor = 0, ypos = 500, yanchor = 0)
            image LLH_4_colorTile65 = "R_horizontal_ll.png"
            show LLH_4_colorTile65 at Position(xpos = 575, xanchor = 0, ypos = 492, yanchor = 0)
            image LLH_4_colorTile66 = "R_vertical_short.png"
            show LLH_4_colorTile66 at Position(xpos = 660, xanchor = 0, ypos = 420, yanchor = 0)
            image LLH_4_colorTile67 = "W_corner_LT.png"
            show LLH_4_colorTile67 at Position(xpos = 638, xanchor = 0, ypos = 470, yanchor = 0)
            image LLH_4_colorTile69 = "R_horizontal_ll.png"
            show LLH_4_colorTile69 at Position(xpos = 725, xanchor = 0, ypos = 360, yanchor = 0)
            image LLH_4_colorTile70 = "R_horizontal_ll.png"
            show LLH_4_colorTile70 at Position(xpos = 800, xanchor = 0, ypos = 360, yanchor = 0)
        else:
            hide LLH_4_colorTile63
            hide LLH_4_colorTile64
            hide LLH_4_colorTile65
            hide LLH_4_colorTile66
            hide LLH_4_colorTile67
            hide LLH_4_colorTile69
            hide LLH_4_colorTile70
    else:
        hide LLH_4_colorTile63
        hide LLH_4_colorTile64
        hide LLH_4_colorTile65
    ...
    if ifGin2 == True:
        if (ifB1in1 == True or ifB2in1 == True or ifGRin1 == True or ifBGin1 == True) or (ifRin1 == True and whileGin4 == True and (ifGRin6 == True or ifBGin6 == True)):
            $LLH_4_node2 = "Green"
            $LLH_4_node3 = "Green"
    ...
    if ifB1in2 == True or ifB2in2 == True:
        if (ifGin1 == True or ifB1in1 == True or ifB2in1 == True or ifGRin1 == True or ifBGin1 == True) or (ifRin1 == True and whileGin4 == True and (ifGRin6 == True or ifBGin6 == True)):
            $LLH_4_BEnd1 = "On"
            $LLH_4_node3 = "Blue"
...
#win conditions ********
    if ifRin1 == True and (ifB1in2 == True or ifB2in2 == True) and elsein3 == True and whileGin4 == True and (ifB1in5 == True or ifB2in5 == True) and ifBGin6 == True and ifGRin7 == True and ifGin8 == True:
...
#lose conditions ********
    if attempts == 0:
        ...
        hide LLH_4_colorTile92
        hide LLH_4_colorTile93
        hide LLH_4_colorTile94
        hide LLH_4_colorTile95
        hide LLH_4_colorTile96
        hide LLH_4_colorTile97 
        hide LLH_4_colorTile98
        hide LLH_4_colorTile99
        ...
        hide LLH_4_BlueEnd1_Off
        hide LLH_4_BlueEnd2_Off
        hide LLH_4_GreenEnd1_Off
        hide LLH_4_GreenEnd2_Off        
        hide LLH_4_RedEnd_Off
        hide LLH_4_BlueEnd1_On
        hide LLH_4_BlueEnd2_On
        hide LLH_4_GreenEnd1_On
        hide LLH_4_GreenEnd2_On
        hide LLH_4_RedEnd1_On
        hide LLH_4_RedEnd2_On
