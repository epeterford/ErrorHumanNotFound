...
#    ****************************************************
    ...
    show LLE_4_ifGT at Position(xpos = if1x, xanchor = 0, ypos = if1y, yanchor = 0)
    show LLE_4_ifBT at Position(xpos = if2x, xanchor = 0, ypos = if2y, yanchor = 0)
    show LLE_4_elseT at Position(xpos = if3x, xanchor = 0, ypos = if3y, yanchor = 0)
...
#*******************************************
    ...
    if not(if1in3 or (if3in3 and if2in2)): 
        if (light3Sound ==1):
