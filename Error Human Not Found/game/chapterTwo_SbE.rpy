...
label letherfinish:
    ...
    a "Fine. Do not answer me. Should have taken a bonus to persuade. Maybe she just rolls natural 20s for ignoring everyone."
...
label adapls:
    ...
    #show Ada frustrated
    a "I was hardly organizing a tour, I was plotting the optimal route to Alpha. We do not have any time to waste."
    g "If you think I'm skulking through a maintenance shaft, you'd be dead wrong. I have enough to worry about."
    #Grace's sprite disappears here.
    #show Ada seething
    a "Very well, Grace. Let us take your route. It is not like I can process several hundred times faster and more accurately than you or anything."
    jump gettingin
...
label askherifshesalright:
    ...
    a "It is different. Running emotional simulations versus experiencing them while inhabiting the hardware is... overwhelming."
...
label wegotstufftodo:
    ...
    #show Ada seething
    a "My records indicate you have no siblings, Grace. {i}You{/i} are the one who does not know."
...
label letthepuzzlesbegin:
    ...
    #    #GRACE'S PUZZLE #REDO/flesh out these comments
    #	if (attempts==1):
    ##show Grace happy
...
label enterthemopr:
    ...
    #show Grace surprised
    #show Ada concerned
    g "Short-freaking-circuited!"
    a "Grace!"
 
    #show Mopr
    mopr "[Inquisitive boop.]"
    #show Ada amused
    a "Oh. It looks like it is just a cleaning robot."
    #show Grace happy
    ...
    "The robot's camera pans across Ada and Grace, and then settles on Alpha. You poor little beep-boop."
    ...
    mopr "[Worried blorp.]"
    g "I know it's tough, little guy, finding two strangers and a body during your cleaning cycle."
...
label igothisada:
    ...
    a "I was not trying to insinuuate doubt as to your capabilities, just point out that I am uniquely suited to handle this."
    g "Thanks for the thought, but I have a soft spot for these guys. Won't take long at all."
    g "As my dad would say, I can get on their level. They respect that. He may just be a maintenance droid, but he's got some sort of feelings too."
    a "Very well, Grace..."
    jump exitthemopr
