...
label blahoksure_E:
    $quick_menu = True
    $points_SbE +=3
    show Grace neutral at left behind Ivan
    show Ada neutral at right
    show Ivan disgusted at center
...
label youandmetogether_E:
    ...
    show Ada annoyed
    a "Because of our combined effort, we found that you are the next suspect."
    show Grace happy
...
label ch3resume3_E:
    ...
    show Grace snarky
    g "Then we'll get out of that non-existent mess you call your hair."
