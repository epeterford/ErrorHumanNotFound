...
#    ****************************************************
    ...
    show LLM_1_ifGT at Position(xpos = if2x, xanchor = 0, ypos = if2y, yanchor = 0)
    show LLM_1_ifBT at Position(xpos = if1x, xanchor = 0, ypos = if1y, yanchor = 0)
    show LLM_1_elseT at Position(xpos = else1x, xanchor = 0, ypos = else1y, yanchor = 0)
    show LLM_1_whileBT at Position(xpos = while1x, xanchor = 0, ypos = while1y, yanchor = 0)
...
#*******************************************
    ...
    if ((temp_slot == "" and temp_gate == "" and slot_name != "null") and not(slot_name == "G_if_gate_return" or slot_name == "B_if_gate_return" or slot_name == "G_else_gate_return" or slot_name == "while_gate_blue_return")):
        $ temp_slot = slot_name
        $ temp_gate = gate_name
...
#    #if 1 section*******************************************************************************************     
    ...
    if not(if1in1 or (if2in2 and else1in1)):
        if(light1Sound==1):
